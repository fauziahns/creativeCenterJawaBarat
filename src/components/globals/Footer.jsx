    ...
    <div className='bg-[#1A8C44] py-[50px] px-[50px]'>
      <div className="flex items-center">
        <div className="flex flex-col max-w-[50%] p-10">
            <div className="flex items-center">
                <img src={assets.logoNav} alt="" className='w-[155px]'/>
                <img src={assets.logoNav2} alt="" className='w-[312px] h-[60px]'/>
            </div>
            ...
            <div className="flex mt-6">
                <img src={assets.facebook} alt="" className='w-[40px] h-[37px] mr-2'/>
                <img src={assets.instagram} alt="" className='w-[36px] h-[36px] mr-2'/>
                <img src={assets.twitter} alt="" className='w-[35px] h-[35px] mr-2'/>
                <img src={assets.youtube} alt="" className=''/>
            </div>
        </div>
