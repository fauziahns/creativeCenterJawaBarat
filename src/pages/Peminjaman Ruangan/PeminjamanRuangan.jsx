...
const validation = Yup.object().shape({
  namaPemohon: Yup.string().required("Nama Pemohon Harus Diisi").min(3, "Nama Pemohon Minimal Terdiri Dari 3 Karakter"),
  ...
  noPemohon: Yup.number().integer().required("Nomor Telepon Pemohon Harus Diisi"),
  nikPemohon: Yup.number().integer().required("NIK Pemohon Harus Diisi"),
  emailPemohon: Yup.string().email("Format Email Harus Benar").required("Email Pemohon Harus Diisi"),
})
      ...
      <div className="flex bg-white">
        ...
        <div className="flex flex-col bg-[#fcfcfc] w-[40%] m-7 rounded-lg border justify-center">
            ...
            <TextArea
                ...
                onChange={handleOnChange}/>
            <div className="ml-[85px]">
              <p className='text-red-500 text-[13px]'>{formik.errors.alamatPemohon}</p>
            </div>
            ...
            onChange={handleOnChange}/>
            <div className="ml-[85px]">
              <p className='text-red-500 text-[13px]'>{formik.errors.kecamatanPemohon}</p>
            </div>
            ...
            onChange={handleOnChange}/>
            <div className="ml-[85px]">
              <p className='text-red-500 text-[13px]'>{formik.errors.kelurahanPemohon}</p>
            </div>
            ...
            <div className="ml-[85px]">
              <p className='text-red-500 text-[13px]'>{formik.errors.statusPemohon}</p>
            </div>
